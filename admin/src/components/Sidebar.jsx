...
import ListProductImage from '../assets/productlist.png';
    ...
    <div className='py-7 flex justify-center gap-x-2 gap-y-5 w-full bg-white sm:gap-x-4 lg:flex-col lg:pt-20 lg:max-w-60 lg:h-screen lg:justify-start lg:pl-6'>
        <Link to={'/addProduct'}>
            <button className='flexCenter gap-2 rounded-md bg-primary h-12 w-40 xs:w-44 medium-16'>
                <img src={AddProductImage} alt='addProduct' height={50} width={50} />
                <span>Add Product</span>
            </button>
        </Link>
        <Link to={'/listProduct'}>
            <button className='flexCenter gap-2 rounded-md bg-primary h-14 w-40 xs:w-44 medium-16'>
                <img src={ListProductImage} alt='addProduct' height={50} width={50} />
