            ...
            <div className='flex flex-col gap-14 xl:flex-row '>
                ...
                <div className='flex gap-x-2 xl:flex-1'>
                    <div className='flex flex-col gap-[7px] flex-wrap'>
                        ...
                        <img src={product_rt_3} alt='productId' className='max-h-[99px]' />
                        <img src={product_rt_4} alt='productId' className='max-h-[99px]' />
                    </div>
                ...
                <div className='flex-col flex xl:flex-[1.7]'>
                    ...
                    <div className='flex gap-x-6 medium-20 my-4'>
                        ...
                        <div className='text-sky-600'>{product.new_price}</div>
                    ...
                    <div className='mb-4'>
                        ...
                        <p><span className='medium-16 text-tertiary'>Tags : </span>Modern | Lastes</p>
                    </div>
                </div>
            </div>
        </section>
