    ...
    return <>
        <div className='rounded-xl overflow-hidden shadow-lg'>
            ...
            <div className='relative flexCenter group overflow-hidden transition-all duration-100'>
                <Link to={`/product/${id}`} className='h-8 w-8 bg-white rounded-full flexCenter absolute top-1/2 bottom-1/2 !py-2 z-20 scale-0 group-hover:scale-125 transition-all duration-700'>
            ...
            <div className='p-4 overflow-hidden '>
                ...
                <div className='flex gap-5'>
                    <div className='bold-16 text-sky-600'>{new_price}.00</div>
                    <div className=' bold-16 line-through' >{old_price}.00</div>
                </div>
